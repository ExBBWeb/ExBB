...
<form action="" method="POST" data-ajax-form>
	...
	<a href="#" id="uLogin" data-ulogin="display=window;fields=nickname,email,first_name,last_name;redirect_uri=<?php echo $url->module('user', 'index', 'RegisterULogin'); ?>"><img src="https://ulogin.ru/img/button.png" width="187" height="30" alt="МультиВход"/></a>
